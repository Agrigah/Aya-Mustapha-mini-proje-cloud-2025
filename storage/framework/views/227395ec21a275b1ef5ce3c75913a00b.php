...
<section class="detail py-5 bg-light">
    <div class="container d-flex h-100">
        <div class="informations w-50 h-100 px-5 animate-content">
            <img src="<?php echo e(asset($car->images)); ?>" alt="voiture" class="w-100 h-50 rounded-lg animate-img" />
            <div class="mt-3">
                <h2 class="mb-2 fs-5 fw-medium text-center  p-3 mb-3 animate-text"style="background-color: #010530; color: white;"><?php echo e($car->model); ?></h2>
                <p class="mb-2 fs-5 fw-light"><b>Designation</b>: <?php echo e($car->brand); ?></p>
                <p class="mb-2 fs-5 fw-light"><b>Model</b>: <?php echo e($car->model); ?></p>
                ...
                <p class="mb-2 fs-5 fw-light"><b>Année d'apparution</b>: <?php echo e($car->year); ?></p>
                <p class="mb-2 fs-5 fw-light"><b>Description</b>: <?php echo e($car->description); ?></p>
            </div>
        </div>
        <div class="planification w-50 h-100 d-flex flex-column justify-content-between">
            ...
            <div class="my-3 reservations animate-content">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $rentals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rental): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <ul>
                        <li class="fs-4"><?php echo e(Str::substr($rental->rental_date, 0, 10)); ?> - <?php echo e(Str::substr($rental->return_date, 0, 10)); ?></li>
                    </ul>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <p class="text-center mt-5">Aucune réservation planifiée sur cette voiture</p>
                <?php endif; ?>
            </div>
            <form class="new-reservation animate-form" method="POST" action="<?php echo e(route('rental.create', ['carId' => $car->id ])); ?>">
                <?php echo csrf_field(); ?>
                <div class="mt-4">
                ...
                <?php endif; ?>
                <?php if($errors->reservationErrors->any()): ?>
                    <div class="mt-3 alert alert-danger">
                        <ul>
                            <?php $__currentLoopData = $errors->reservationErrors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Votre réservation pour la <?php echo e($car->model); ?> a été
                    confirmée.</p>
...
<?php /**PATH C:\Users\Hp\Downloads\CarRentalManagement-Laravel-main\resources\views/detailCars.blade.php ENDPATH**/ ?>