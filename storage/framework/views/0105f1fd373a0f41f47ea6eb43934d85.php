...
<section class="dashboard d-flex">
  <div class="tables w-25 h-100" style="background-color: #010530; color: white; py-5 d-flex flex-column;">
    ...
    <div class="w-75 h-100 d-flex  justify-content-center details">
        <form class="row h-75 m-5 p-5 text-bg-light" method="POST" action="<?php echo e(route('cars.create')); ?>">
            <?php echo csrf_field(); ?>
            <div class="col-md-4">
...
<?php echo $__env->make('../_footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Hp\Downloads\CarRentalManagement-Laravel-main\resources\views/dashboard/createCars.blade.php ENDPATH**/ ?>