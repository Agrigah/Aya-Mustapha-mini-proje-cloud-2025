...
<section class="welcome">
    <div class="item d-flex flex-column align-items-center justify-content-center text-white">
        ...
        <a href="<?php echo e(route('car.cars')); ?>" class="btn btn-custom animate-btn">Découvrez nos voitures</a>
    </div>
</section>
...
<section class="about py-5">
    <div class="container d-flex justify-content-between about-container">
        ...
        <div class="d-flex flex-column justify-content-between content">
            ...
            <a href="<?php echo e(route('page.contact')); ?>" class="btn btn-custom animate-btn">Contactez-nous</a>
        </div>
    </div>
</section>
            ...
            <?php $__currentLoopData = $cars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $car): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="item d-flex flex-column justify-content-between p-3">
                    ...
                    <button class="btn btn-custom">
                        <a class="lien" href="<?php echo e(route('cars.detail', ['id' => $car->id])); ?>">Voir plus</a>
                    </button>
                </div>
        ...
        <div class="mt-5 d-flex flex-wrap justify-content-between all-testimonies">
            <div class="testimony-item p-3">
                ...
                <div class="testimony-user">
                    <img src="<?php echo e(asset('assets/v1.webp')); ?>" class="testimony-user-logo">
            ...
            <div class="testimony-item p-3">
                ...
                <div class="testimony-user">
                    <img src="<?php echo e(asset('assets/v4.jpg')); ?>" class="testimony-user-logo">
            ...
            <div class="testimony-item p-3">
                ...
                <div class="testimony-user">
                    <img src="<?php echo e(asset('assets/v3.jpg')); ?>" class="testimony-user-logo">
                    <p>Samira Bandolo</p>
                </div>
...
<?php /**PATH C:\Users\Hp\Downloads\CarRentalManagement-Laravel-main\resources\views/welcome.blade.php ENDPATH**/ ?>