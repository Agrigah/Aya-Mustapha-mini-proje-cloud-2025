...
<section class="dashboard d-flex">
    ...
    <div class="w-75 h-100 d-flex align-items-start details">
        <table class="table mx-5 mt-3 h-100 text-center">
            <thead class="bg-blue text-yellow">
                <tr>
                   <th scope="col">id</th>
         ...
         <tbody>
            <?php $__currentLoopData = $cars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $car): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <th scope="col"><?php echo e($car->id); ?></th>
                    ...
                    <td>
                        <a href="<?php echo e(route('cars.edit' , ['id' => $car->id])); ?>" class="btn btn-success">Modifier</a>
                        <form action="<?php echo e(route('cars.delete', ['id' => $car->id])); ?>" method="POST" style="display: inline;">
                            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\Hp\Downloads\CarRentalManagement-Laravel-main\resources\views/dashboard/cars.blade.php ENDPATH**/ ?>