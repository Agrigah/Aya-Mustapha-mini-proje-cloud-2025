...
<section class="login">
    <div class="container d-flex justify-content-center align-items-center login-container">
        <form class="w-50 my-5 px-5 py-3 form animated-form" method="POST" action="{{ route('user.login') }}">
            @csrf
            <div class="mb-3">
            ...
            <p class="mt-3 text-dark">Vous n'avez pas un compte ? <i><a href="{{ route('page.register') }}" class="text-warning">Inscrivez-vous</a></i></p>
        </form>
    </div>
</section>
